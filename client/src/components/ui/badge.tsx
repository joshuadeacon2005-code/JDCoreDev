...
const badgeVariants = cva(
  'whitespace-nowrap inline-flex items-center justify-center border font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0 hover-elevate',
  {
    variants: {
      variant: {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: 'outline',
        className:
          'border bg-teal-100 text-teal-700 border-teal-200 dark:text-teal-600 dark:bg-teal-950/50 dark:border-teal-950',
      },
      {
        variant: 'mono',
        appearance: 'outline',
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'border bg-teal-100 text-teal-700 dark:text-teal-600 dark:bg-teal-950/50',
      },
      {
        variant: 'mono',
        appearance: 'light',
      ...
      { variant: 'info', appearance: 'ghost', className: 'text-teal-500' },
