...
const AnimatedShaderBackground = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('WebGL not supported, showing fallback background');
      setWebglError(true);
      return;
    }
  }, []);
  ...
  if (webglError) {
    return (
      <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-teal-900/50 via-emerald-800/30 to-cyan-900/50" />
    );
  }
