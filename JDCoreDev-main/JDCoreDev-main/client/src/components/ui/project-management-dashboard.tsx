...
export function ProjectDashboard({
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        if (isMessagesOpen) setMessagesOpenState(false);
  ...
  const setMessagesOpenState = (open: boolean) => {
      ...
      <header className={cx(
        ...
        <div className={cx("flex items-center", spacing.gap.xs)}>
          ...
          <button
            ...
            onClick={() => setMessagesOpenState(true)}
        ...
        <main className={cx(
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
            ...
            <div className={cx("flex items-center", spacing.gap.xs)}>
              ...
              >
                <Icons.Arrow className="size-4 rotate-90" />
              </button>
          ...
          {reorderMode && (
            <div className="mb-3 p-3 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 text-sm text-indigo-700 dark:text-indigo-300">
              Reorder mode active. Use arrow keys to move items, Home/End for first/last position, Escape to exit.
            </div>
          )}
                    ...
                    <div className={cx(
                      ...
                      <div className="flex -space-x-2">
                        ...
                        <button
                          ...
                          disabled={reorderMode}
                          data-testid={`button-add-participant-${p.id}`}
                        >
        ...
        >
          <div className={cx(
            ...
            <button
              ...
              onClick={() => setMessagesOpenState(false)}
            ...
            <form className="space-y-3" onSubmit={submitCreate}>
              ...
              <label className="block">
                ...
                <input
                  ...
                  data-testid="input-create-progress"
                />
              </label>
