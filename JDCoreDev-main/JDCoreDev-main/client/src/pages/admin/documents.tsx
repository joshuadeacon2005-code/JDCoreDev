...
import { FileText, Download, Upload, File, Trash2, Eye, Briefcase, Server, ChevronDown } from "lucide-react";
import { format } from "date-fns";
import { HostingInvoiceGeneratorDialog } from "@/components/HostingInvoiceGeneratorDialog";
import { DevelopmentInvoiceGeneratorDialog } from "@/components/DevelopmentInvoiceGeneratorDialog";
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" data-testid="button-generate-invoice-dropdown">
              ...
              <DropdownMenuContent align="end">
                <DevelopmentInvoiceGeneratorDialog
                  trigger={
                    <DropdownMenuItem onSelect={(e) => e.preventDefault()} data-testid="menu-development-invoice">
                ...
                <HostingInvoiceGeneratorDialog
                  trigger={
                    <DropdownMenuItem onSelect={(e) => e.preventDefault()} data-testid="menu-hosting-invoice">
